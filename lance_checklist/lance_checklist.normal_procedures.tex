...
\begin{checklist}{Engine Start}
    ...
    \checkitem{Fuel selector}{desired tank}
...
\begin{checklist}{Climb}
    \checkitem{Throttle}{25$''$ MP}
    \checkitem{Prop}{2500 RPM}
    \checkitem{Mixture}{full rich or target EGT}
    \checkitem{Airspeed}{104 KIAS}
\end{checklist}

\begin{checklist}{Cruise}
    \checkitem{Throttle}{22$''$ MP}
    \checkitem{Prop}{2400 RPM}
    \checkitem{Mixture}{17.5 GPH}
    \checkitem{Airspeed}{$\approx$ 135 KIAS}
\end{checklist}
