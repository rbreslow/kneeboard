...
\newcommand{\bookemptyweight}{2188}
\newcommand{\maxgrossweight}{3600}
% Approximately two 160 lb adults, 20 lb of baggage, and 74 gal of fuel remaining.
\newcommand{\grossweight}{3000}
...
% gross weights."
\newcommand{\maneuveringspeed}{\fpeval{112 + (\grossweight - \bookemptyweight) * ((132 - 112) / (\maxgrossweight - \bookemptyweight))}}
...
\newcommand{\bestglidespeed}{\scaledvspeed{92}}

\phantomsection
\addcontentsline{toc}{subsection}{Lance flight maneuver entry speeds at \num{\grossweight} lbf}
...
\begin{table}[H]
    ...
    \begin{center}
        \begin{tabular}{lc}
            ...
            %      so we round up to the nearest 10 knots:
