...
\begin{checklist_emerg}{Engine Failure During Takeoff (Below 89 KIAS or Gear Down)}
    \begin{flushright}
...
\begin{checklist_emerg}{Engine Failure During Takeoff (Above 89 KIAS)}
    \begin{flushright}
        \checkitem{Airspeed}{maintain 91 KIAS}
        \checkitem{Mixtures}{full forward}
        \checkitem{Props}{full forward}
        \checkitem{Throttles}{full forward}
        \checkitem{Flaps}{up}
...
\begin{checklist_emerg}{Engine Troubleshooting}
    ...
    \begin{flushright}
        ...
        \checkitem{Fuel pump}{on, if\\power is not immediately\\restored, off}
    \end{flushright}
...
\begin{checklist_emerg}{Manual Extension of Landing Gear}
    ...
    \checkitem{Airspeed}{reduce (87 KIAS max.)}
    \checkitem{Landing gear}{down}
    \checkitem{Motor release arm}{raise and push full forward}
    \checkitem{Gear extension handle}{rotate full forward}
