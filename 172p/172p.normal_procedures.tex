...
\begin{checklist}{Cruise}
    % From Cessna 172P POH, cruise performance, 2400 pounds, standard
    % temperature, 2000 ft pressure altitude. 69% BHP.
    \checkitem{Throttle}{2400 RPM}
    \checkitem{Mixture}{best power}
    \checkitem{Fuel flow}{7.7 GPH}
    % https://aerotoolbox.com/airspeed-conversions/ says 109 kts TAS at 2000 ft
    % is 105.859 kts CAS. Airspeed correction table says 106 kts CAS is ~108
    % kts IAS.
    \checkitem{Airspeed}{108 KIAS}
